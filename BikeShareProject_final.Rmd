...
knitr::opts_knit$set(root.dir = '/BikeShareSuccess/Data')
```
...
listcsv <- list.files(pattern = "*.csv") #List all the data file in the folder
listcsv
```
...
Thus, since we will only focus on the analyzing data between with short trips of less than or equal 45 minutes and greater than 10 seconds.
